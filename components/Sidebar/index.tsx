  ...
  return (
    <>
      ...
      <div className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full  flex-col justify-between hidden sm:flex">
          ...
          <ul className="mt-12">
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Deposit</span>
              </div>
            </li>
            </Link>
            ...
            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Withdraw</span>
              </div>
            </li>
            </Link>
        ...
        <div className="h-auto bg-[#fff] my-10 mx-3 rounded-sm p-4">
          <div className="container mx-auto ">
              <p className=" font-bold">Token: <span className=" font-normal">10 BT</span></p>
          </div>
        </div>
      </div>
    </>
